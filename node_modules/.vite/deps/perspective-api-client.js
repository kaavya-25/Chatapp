...
// node_modules/perspective-api-client/index.js
var require_perspective_api_client = __commonJS({
  "node_modules/perspective-api-client/index.js"(exports, module) {
    ...
    var Perspective = class {
      ...
      getAnalyzeCommentPayload(text, options) {
        const opts = options || {};
        const stripHTML = opts.stripHTML == void 0 ? true : opts.stripHTML;
        const truncate = opts.truncate == void 0 ? false : opts.truncate;
        const doNotStore = opts.doNotStore == void 0 ? true : opts.doNotStore;
        const validate = opts.validate == void 0 ? true : opts.validate;
        ...
        let attributes = opts.attributes == void 0 && !resource.requestedAttributes ? { TOXICITY: {} } : opts.attributes;
...
export default require_perspective_api_client();
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=perspective-api-client.js.map
